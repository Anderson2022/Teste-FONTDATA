...
@Entity
@Table(name = "usuario_tarefa", uniqueConstraints = @UniqueConstraint(name = "uk_usuario_tarefa", columnNames = {
...
public class UsuarioTarefa {
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "atribuido_por", nullable = false)
    ...
    public Usuario getAtribuidoPor() {
        return atribuidoPor;
    }

    public void setAtribuidoPor(Usuario atribuidoPor) {
